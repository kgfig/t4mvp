...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private final View.OnTouchListener mDelayHideTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (AUTO_HIDE) {
                ...
                Toast.makeText(FullscreenActivity.this, "Clicked on videoview", Toast.LENGTH_SHORT).show();
            }
            return false;
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Media video = new Media("Sample fullscreen", "video1", AppContract.MediaEntry.TYPE_VIDEO);
        ...
        mContentView = (VideoView) findViewById(R.id.fullscreen_video_view_content);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(itemId) {
            case R.id.fullscreen_action_fullscreen:
